...
public class JwtSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private com.employee.service.JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint;
	...
	protected void configure(HttpSecurity http) throws Exception {
		/*
		 * http.authorizeRequests().antMatchers("/api/v1/emp/getAllEmployees").permitAll
		 * () // Define your public URL .antMatchers("/user/login").permitAll() //
